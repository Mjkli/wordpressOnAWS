...
build {
  ...
  provisioner "shell"{
    inline = [
      ...
      "sudo apt-get install memcached libmemcached-tools zip nfs-common apache2 mysql-client ghostscript libapache2-mod-php mysql-server php php-bcmath php-curl php-imagick php-intl php-json php-mbstring php-mysql php-xml php-zip -y",
